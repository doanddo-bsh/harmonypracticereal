...
**확인 완료 (2026-08-04):** Play 콘솔 프로덕션 트랙의 최신 출시 버전이 **16 (1.1.0)** 이다.
따라서 다음 업로드는 versionCode **17 이상**이어야 하며 `1.2.0+17` 이 맞다.
(참고: 현재 설치 수 93회, 배포 국가 177개. 규모가 작아 `minSdk 21 → 24` 로 인한 기기 탈락 영향은 무시 가능하다.)
