...
class _tonalityProblemType2State extends State<tonalityProblemType2> {
  ...
  /// 오선과 보기 버튼 **사이** — 구분선 · 안내문 · 조/화성 Row · 구분선 · 여백.
  ///
  /// 종전 build() 의 5개 자식을 순서·여백 그대로 옮겼다. 구분선 두 개는 유형 1
  /// 과 달리 **높이 지정이 없고**, 마지막 여백은 `10.h` 가 아니라 생짜 `10` 인
  /// `Container` 다. 유형마다 다른 값이라 껍데기로 올리지 않았다
  /// (QuizPageScaffold 주석의 표).
  ...
  /// 보기 버튼 영역 — 유형 2 는 Row 하나다(유형 1 은 Column 이 감쌌다).
